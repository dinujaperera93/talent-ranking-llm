...
#
# Top-10 candidate IDs selected by each method — 22 columns total.
#
...
#
# **LLM methods (16):** top-10 from 4 prompting techniques × 4 models (Qwen-1.5B, Gemma-4-E2B-it, Llama-3.1-8B, GLM-4-9B).
#
